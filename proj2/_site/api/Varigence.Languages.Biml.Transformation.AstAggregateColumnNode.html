...
<html>
  ...
  <head>
    ...
    <title>Class AstAggregateColumnNode
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class AstAggregateColumnNode
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode">
  
  
  <h1 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode" class="text-break">Class AstAggregateColumnNode
  </h1>
  <div class="markdown level0 summary"><p>The Aggregate Column transformation applies aggregate functions to specified column values and copies results to specified destination locations.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level2"><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html">AstDataflowColumnMappingNode</a></div>
    <div class="level3"><span class="xref">AstAggregateColumnNode</span></div>
  </div>
  ...
  <div class="inheritedMembers">
    ...
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Name">AstDataflowColumnMappingNode.Name</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_SourceColumn">AstDataflowColumnMappingNode.SourceColumn</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_TargetColumn">AstDataflowColumnMappingNode.TargetColumn</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_IsUsed">AstDataflowColumnMappingNode.IsUsed</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_SortKeyPosition">AstDataflowColumnMappingNode.SortKeyPosition</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_SourceColumnDefaultValue">AstDataflowColumnMappingNode.SourceColumnDefaultValue</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_TargetColumnDefaultValue">AstDataflowColumnMappingNode.TargetColumnDefaultValue</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_IsUsedDefaultValue">AstDataflowColumnMappingNode.IsUsedDefaultValue</a>
    </div>
    <div>
      <a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_SortKeyPositionDefaultValue">AstDataflowColumnMappingNode.SortKeyPositionDefaultValue</a>
    </div>
    <div>
  ...
  <h5 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class AstAggregateColumnNode : AstDataflowColumnMappingNode, IBindableItem, IFrameworkItem, IXObjectMappingProvider, IValidationInfo, IDataErrorInfo, IVulcanCollectionParent, IVulcanNotifyPropertyChanged, INotifyPropertyChanged, IPropertyChangeNotificationTarget, INamedItem</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode__ctor_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.#ctor*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode__ctor_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.#ctor(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">AstAggregateColumnNode(IFrameworkItem)</h4>
  <div class="markdown level1 summary"><p>Initializes a new instance of the AstAggregateColumnNode class with the specified parent node.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AstAggregateColumnNode(IFrameworkItem parentItem)</code></pre>
  </div>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComparisonFlags_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComparisonFlags*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComparisonFlags" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComparisonFlags">ComparisonFlags</h4>
  <div class="markdown level1 summary"><p>This value specifies a collection of flags that determine specific behaviors of the Aggregate component when comparing column values.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public VulcanCollection&lt;ComparisonFlags&gt; ComparisonFlags { get; }</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">Varigence.Utility.Collections.VulcanCollection</span>&lt;<a class="xref" href="Varigence.Languages.Biml.Transformation.ComparisonFlags.html">ComparisonFlags</a>&gt;</td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComparisonFlagsDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComparisonFlagsDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComparisonFlagsDefaultValue" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComparisonFlagsDefaultValue">ComparisonFlagsDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the ComparisonFlags property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static ComparisonFlags ComparisonFlagsDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Transformation.ComparisonFlags.html">ComparisonFlags</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComposedComparisonFlags_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComposedComparisonFlags*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ComposedComparisonFlags" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ComposedComparisonFlags">ComposedComparisonFlags</h4>
  <div class="markdown level1 summary"><p>Gets or sets a single ComparisonFlags value that consists of the collection of items in the ComparisonFlags property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ComparisonFlags ComposedComparisonFlags { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctKeys_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctKeys*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctKeys" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctKeys">CountDistinctKeys</h4>
  <div class="markdown level1 summary"><p>This value specifies exactly how many distinct values the transformation can count in a column. If values are specified for both CountDistinctScale and CountDistinctKeys, CountDistinctKeys takes precedence.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public int CountDistinctKeys { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctKeysDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctKeysDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctKeysDefaultValue" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctKeysDefaultValue">CountDistinctKeysDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the CountDistinctKeys property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static int CountDistinctKeysDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctScale_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctScale*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctScale" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctScale">CountDistinctScale</h4>
  <div class="markdown level1 summary"><p>This value specifies approximately how many distinct values the transformation can count in a column. The default value is Unspecified. If values are specified for both CountDistinctScale and CountDistinctKeys, CountDistinctKeys takes precedence.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AggregateTransformScale CountDistinctScale { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Transformation.AggregateTransformScale.html">AggregateTransformScale</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctScaleDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctScaleDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CountDistinctScaleDefaultValue" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CountDistinctScaleDefaultValue">CountDistinctScaleDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the CountDistinctScale property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static AggregateTransformScale CountDistinctScaleDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_FriendlyTypeName_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.FriendlyTypeName*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_FriendlyTypeName" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.FriendlyTypeName">FriendlyTypeName</h4>
  ...
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_FriendlyTypeName">AstDataflowColumnMappingNode.FriendlyTypeName</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_FriendlyTypeNameStatic_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.FriendlyTypeNameStatic*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_FriendlyTypeNameStatic" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.FriendlyTypeNameStatic">FriendlyTypeNameStatic</h4>
  <div class="markdown level1 summary"><p>Gets the friendly name of the type of this node</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Operation_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Operation*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Operation" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Operation">Operation</h4>
  <div class="markdown level1 summary"><p>This value specifies which aggregation operation will be used.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AggregateTransformOperation Operation { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Transformation.AggregateTransformOperation.html">AggregateTransformOperation</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_OperationDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.OperationDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_OperationDefaultValue" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.OperationDefaultValue">OperationDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the Operation property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static AggregateTransformOperation OperationDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_SelectedComparisonFlagsText_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.SelectedComparisonFlagsText*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_SelectedComparisonFlagsText" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.SelectedComparisonFlagsText">SelectedComparisonFlagsText</h4>
  <div class="markdown level1 summary"><p>Gets a string value that lists all of the ComparisonFlags values that have been selected</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string SelectedComparisonFlagsText { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_BindingScopeBoundaries_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.BindingScopeBoundaries*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_BindingScopeBoundaries" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.BindingScopeBoundaries">BindingScopeBoundaries()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_BindingScopeBoundaries">AstDataflowColumnMappingNode.BindingScopeBoundaries()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CopyFrom_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CopyFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_CopyFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.CopyFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences)">CopyFrom(IFrameworkItem, UnboundReferences)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_CopyFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_">AstDataflowColumnMappingNode.CopyFrom(IFrameworkItem, UnboundReferences)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate">Duplicate()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Duplicate">AstDataflowColumnMappingNode.Duplicate()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate(System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstDataflowColumnMappingNode.Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">Duplicate(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstDataflowColumnMappingNode.Duplicate(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstDataflowColumnMappingNode.Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_DuplicateHusk_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.DuplicateHusk*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.DuplicateHusk(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">DuplicateHusk(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstDataflowColumnMappingNode.DuplicateHusk(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_DuplicateInto_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.DuplicateInto*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.DuplicateInto(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstDataflowColumnMappingNode.DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_EmitXmlForAction_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.EmitXmlForAction*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_EmitXmlForAction_Varigence_Flow_FlowFramework_Engine_Actions_AstEnginePropertyAction_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.EmitXmlForAction(Varigence.Flow.FlowFramework.Engine.Actions.AstEnginePropertyAction)">EmitXmlForAction(AstEnginePropertyAction)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_EmitXmlForAction_Varigence_Flow_FlowFramework_Engine_Actions_AstEnginePropertyAction_">AstDataflowColumnMappingNode.EmitXmlForAction(AstEnginePropertyAction)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_EmitXmlForProperty_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.EmitXmlForProperty*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_EmitXmlForProperty_System_String_System_Int32_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.EmitXmlForProperty(System.String,System.Int32)">EmitXmlForProperty(String, Int32)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_EmitXmlForProperty_System_String_System_Int32_">AstDataflowColumnMappingNode.EmitXmlForProperty(String, Int32)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlAttributeFragment_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlAttributeFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlAttributeFragment_Varigence_Utility_Common_CulturedStringBuilder_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlAttributeFragment(Varigence.Utility.Common.CulturedStringBuilder)">GetBimlAttributeFragment(CulturedStringBuilder)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_GetBimlAttributeFragment_Varigence_Utility_Common_CulturedStringBuilder_">AstDataflowColumnMappingNode.GetBimlAttributeFragment(CulturedStringBuilder)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlChildFragment_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlChildFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlChildFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlChildFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32)">GetBimlChildFragment(CulturedStringBuilder, Int32)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlFragment_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetBimlFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32,System.Boolean)">GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_">AstDataflowColumnMappingNode.GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetDefaultValue_System_String_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetDefaultValue(System.String)">GetDefaultValue(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetDefaultValue__1_System_String_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetDefaultValue``1(System.String)">GetDefaultValue&lt;T&gt;(String)</h4>
  <div class="markdown level1 summary"><p>Retrieves the default value for the property with the name propertyName</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetJson_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetJson*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetJson_System_Text_StringBuilder_System_Boolean__System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetJson(System.Text.StringBuilder,System.Boolean@,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean)">GetJson(StringBuilder, ref Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_GetJson_System_Text_StringBuilder_System_Boolean__System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_">AstDataflowColumnMappingNode.GetJson(StringBuilder, ref Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetPotentialParentProperties_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetPotentialParentProperties*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetPotentialParentProperties" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetPotentialParentProperties">GetPotentialParentProperties()</h4>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetPropertyValue_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetPropertyValue*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetPropertyValue_System_String_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetPropertyValue(System.String)">GetPropertyValue(String)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_GetPropertyValue_System_String_">AstDataflowColumnMappingNode.GetPropertyValue(String)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetReflectionInfoFromXmlParsePath_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetReflectionInfoFromXmlParsePath*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetReflectionInfoFromXmlParsePath_System_String_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetReflectionInfoFromXmlParsePath(System.String)">GetReflectionInfoFromXmlParsePath(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetSchemaLocalName_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetSchemaLocalName*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_GetSchemaLocalName" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.GetSchemaLocalName">GetSchemaLocalName()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_GetSchemaLocalName">AstDataflowColumnMappingNode.GetSchemaLocalName()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_HasAnyBimlChildNodes_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.HasAnyBimlChildNodes*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_HasAnyBimlChildNodes" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.HasAnyBimlChildNodes">HasAnyBimlChildNodes()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_MergeFrom_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.MergeFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_MergeFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_System_Boolean_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.MergeFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences,System.Boolean)">MergeFrom(IFrameworkItem, UnboundReferences, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_MergeFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_System_Boolean_">AstDataflowColumnMappingNode.MergeFrom(IFrameworkItem, UnboundReferences, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_NotifyCollectionPropertyChanged_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.NotifyCollectionPropertyChanged*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_NotifyCollectionPropertyChanged_System_Object_System_String_System_Collections_Specialized_NotifyCollectionChangedEventArgs_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.NotifyCollectionPropertyChanged(System.Object,System.String,System.Collections.Specialized.NotifyCollectionChangedEventArgs)">NotifyCollectionPropertyChanged(Object, String, NotifyCollectionChangedEventArgs)</h4>
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ParseAttribute_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ParseAttribute*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ParseAttribute_System_Xml_Linq_XAttribute_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ParseAttribute(System.Xml.Linq.XAttribute,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseAttribute(XAttribute, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_ParseAttribute_System_Xml_Linq_XAttribute_Varigence_Flow_FlowFramework_Engine_ParserContext_">AstDataflowColumnMappingNode.ParseAttribute(XAttribute, ParserContext)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ParseChild_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ParseChild*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_ParseChild_System_Xml_Linq_XElement_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.ParseChild(System.Xml.Linq.XElement,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseChild(XElement, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_StructureEquals_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.StructureEquals*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_StructureEquals_System_Object_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.StructureEquals(System.Object)">StructureEquals(Object)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_StructureEquals_System_Object_">AstDataflowColumnMappingNode.StructureEquals(Object)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Validate_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Validate*"></a>
  <h4 id="Varigence_Languages_Biml_Transformation_AstAggregateColumnNode_Validate_Varigence_Flow_FlowFramework_Validation_ValidationReporter_" data-uid="Varigence.Languages.Biml.Transformation.AstAggregateColumnNode.Validate(Varigence.Flow.FlowFramework.Validation.ValidationReporter)">Validate(ValidationReporter)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.Transformation.AstDataflowColumnMappingNode.html#Varigence_Languages_Biml_Transformation_AstDataflowColumnMappingNode_Validate_Varigence_Flow_FlowFramework_Validation_ValidationReporter_">AstDataflowColumnMappingNode.Validate(ValidationReporter)</a></div>
