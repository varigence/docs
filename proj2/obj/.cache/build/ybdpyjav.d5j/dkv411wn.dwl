...
<html>
  ...
  <head>
    ...
    <title>Class AstTabularPartitionNode
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class AstTabularPartitionNode
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode">
  
  
  <h1 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode" class="text-break">Class AstTabularPartitionNode
  </h1>
  <div class="markdown level0 summary"><p>Tabular partition objects correspond directly to SQL Server Analysis Services (SSAS) Tabular Model table partitions, which allow the data stored in tabular tables to be split among multiple chunks or partitions for better performance and management capabilities.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level4"><span class="xref">AstTabularPartitionNode</span></div>
  </div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="Varigence.Languages.Biml.Tabular.html">Varigence.Languages.Biml.Tabular</a></h6>
  <h6><strong>Assembly</strong>: Biml.dll</h6>
  <h5 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class AstTabularPartitionNode : AstScopeBoundaryNode, IBindableItem, IVulcanCollectionParent, IVulcanNotifyPropertyChanged, IPropertyChangeNotificationTarget, INamedNode, IScopeBoundary, IReferenceableItem, IFrameworkItem, INotifyPropertyChanged, IXObjectMappingProvider, IValidationInfo, IDataErrorInfo, INamedItem, IScopedNameIndexable</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode__ctor_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.#ctor*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode__ctor_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.#ctor(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">AstTabularPartitionNode(IFrameworkItem)</h4>
  <div class="markdown level1 summary"><p>Initializes a new instance of the AstTabularPartitionNode class with the specified parent node.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AstTabularPartitionNode(IFrameworkItem parentItem)</code></pre>
  </div>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DataView_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DataView*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DataView" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DataView">DataView</h4>
  <div class="markdown level1 summary"><p>Specifies whether this query returns a full or sample dataset.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public TabularDataViewType DataView { get; set; }</code></pre>
  </div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Tabular.TabularDataViewType.html">TabularDataViewType</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DataViewDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DataViewDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DataViewDefaultValue" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DataViewDefaultValue">DataViewDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the DataView property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static TabularDataViewType DataViewDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Description_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Description*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Description" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Description">Description</h4>
  <div class="markdown level1 summary"><p>Specifies a user facing description that will be used for this tabular partition in reporting client tools.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DescriptionDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DescriptionDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DescriptionDefaultValue" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DescriptionDefaultValue">DescriptionDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the Description property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static string DescriptionDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ErrorMessage_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ErrorMessage*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ErrorMessage" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ErrorMessage">ErrorMessage</h4>
  <div class="markdown level1 summary"><p>Specifies an error message associated with the current state of this tabular partition.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ErrorMessageDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ErrorMessageDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ErrorMessageDefaultValue" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ErrorMessageDefaultValue">ErrorMessageDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the ErrorMessage property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static string ErrorMessageDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_FriendlyTypeName_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.FriendlyTypeName*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_FriendlyTypeName" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.FriendlyTypeName">FriendlyTypeName</h4>
  ...
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_FriendlyTypeName">AstScopeBoundaryNode.FriendlyTypeName</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_FriendlyTypeNameStatic_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.FriendlyTypeNameStatic*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_FriendlyTypeNameStatic" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.FriendlyTypeNameStatic">FriendlyTypeNameStatic</h4>
  <div class="markdown level1 summary"><p>Gets the friendly name of the type of this node</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_RefreshedTime_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.RefreshedTime*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_RefreshedTime" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.RefreshedTime">RefreshedTime</h4>
  <div class="markdown level1 summary"><p>Specifies the date and time at which the data in this tabular partition was last refreshed from the data source.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public DateTime RefreshedTime { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_RefreshedTimeDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.RefreshedTimeDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_RefreshedTimeDefaultValue" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.RefreshedTimeDefaultValue">RefreshedTimeDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the RefreshedTime property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static DateTime RefreshedTimeDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_SourceQuery_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.SourceQuery*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_SourceQuery" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.SourceQuery">SourceQuery</h4>
  <div class="markdown level1 summary"><p>Specifies the query that retrieves data for this partition.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string SourceQuery { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_SourceQueryDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.SourceQueryDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_SourceQueryDefaultValue" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.SourceQueryDefaultValue">SourceQueryDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the SourceQuery property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static string SourceQueryDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_BindingScopeBoundaries_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.BindingScopeBoundaries*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_BindingScopeBoundaries" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.BindingScopeBoundaries">BindingScopeBoundaries()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_BindingScopeBoundaries">AstScopeBoundaryNode.BindingScopeBoundaries()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_CopyFrom_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.CopyFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_CopyFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.CopyFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences)">CopyFrom(IFrameworkItem, UnboundReferences)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_CopyFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_">AstNamedNode.CopyFrom(IFrameworkItem, UnboundReferences)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate">Duplicate()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_Duplicate">AstScopeBoundaryNode.Duplicate()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate(System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstScopeBoundaryNode.Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">Duplicate(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstScopeBoundaryNode.Duplicate(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstScopeBoundaryNode.Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DuplicateHusk_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DuplicateHusk*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DuplicateHusk(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">DuplicateHusk(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstScopeBoundaryNode.DuplicateHusk(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DuplicateInto_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DuplicateInto*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.DuplicateInto(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstScopeBoundaryNode.DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_EmitXmlForAction_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.EmitXmlForAction*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_EmitXmlForAction_Varigence_Flow_FlowFramework_Engine_Actions_AstEnginePropertyAction_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.EmitXmlForAction(Varigence.Flow.FlowFramework.Engine.Actions.AstEnginePropertyAction)">EmitXmlForAction(AstEnginePropertyAction)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_EmitXmlForAction_Varigence_Flow_FlowFramework_Engine_Actions_AstEnginePropertyAction_">AstNamedNode.EmitXmlForAction(AstEnginePropertyAction)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_EmitXmlForProperty_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.EmitXmlForProperty*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_EmitXmlForProperty_System_String_System_Int32_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.EmitXmlForProperty(System.String,System.Int32)">EmitXmlForProperty(String, Int32)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_EmitXmlForProperty_System_String_System_Int32_">AstNamedNode.EmitXmlForProperty(String, Int32)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlAttributeFragment_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlAttributeFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlAttributeFragment_Varigence_Utility_Common_CulturedStringBuilder_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlAttributeFragment(Varigence.Utility.Common.CulturedStringBuilder)">GetBimlAttributeFragment(CulturedStringBuilder)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_GetBimlAttributeFragment_Varigence_Utility_Common_CulturedStringBuilder_">AstNamedNode.GetBimlAttributeFragment(CulturedStringBuilder)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlChildFragment_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlChildFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlChildFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlChildFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32)">GetBimlChildFragment(CulturedStringBuilder, Int32)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlFragment_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetBimlFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32,System.Boolean)">GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_">AstScopeBoundaryNode.GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetConnection_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetConnection*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetConnection" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetConnection">GetConnection()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AstDbConnectionNode GetConnection()</code></pre>
  </div>
  <h5 class="returns">Returns</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Connection.AstDbConnectionNode.html">AstDbConnectionNode</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetDefaultValue_System_String_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetDefaultValue(System.String)">GetDefaultValue(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetDefaultValue__1_System_String_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetDefaultValue``1(System.String)">GetDefaultValue&lt;T&gt;(String)</h4>
  <div class="markdown level1 summary"><p>Retrieves the default value for the property with the name propertyName</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetJson_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetJson*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetJson_System_Text_StringBuilder_System_Boolean__System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetJson(System.Text.StringBuilder,System.Boolean@,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean)">GetJson(StringBuilder, ref Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_GetJson_System_Text_StringBuilder_System_Boolean__System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_">AstNamedNode.GetJson(StringBuilder, ref Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetPotentialParentProperties_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetPotentialParentProperties*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetPotentialParentProperties" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetPotentialParentProperties">GetPotentialParentProperties()</h4>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetPropertyValue_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetPropertyValue*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetPropertyValue_System_String_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetPropertyValue(System.String)">GetPropertyValue(String)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_GetPropertyValue_System_String_">AstNamedNode.GetPropertyValue(String)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetReflectionInfoFromXmlParsePath_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetReflectionInfoFromXmlParsePath*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetReflectionInfoFromXmlParsePath_System_String_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetReflectionInfoFromXmlParsePath(System.String)">GetReflectionInfoFromXmlParsePath(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetSchemaLocalName_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetSchemaLocalName*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_GetSchemaLocalName" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.GetSchemaLocalName">GetSchemaLocalName()</h4>
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_HasAnyBimlChildNodes_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.HasAnyBimlChildNodes*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_HasAnyBimlChildNodes" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.HasAnyBimlChildNodes">HasAnyBimlChildNodes()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_MergeFrom_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.MergeFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_MergeFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_System_Boolean_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.MergeFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences,System.Boolean)">MergeFrom(IFrameworkItem, UnboundReferences, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_MergeFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_System_Boolean_">AstNamedNode.MergeFrom(IFrameworkItem, UnboundReferences, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ParseAttribute_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ParseAttribute*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ParseAttribute_System_Xml_Linq_XAttribute_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ParseAttribute(System.Xml.Linq.XAttribute,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseAttribute(XAttribute, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_ParseAttribute_System_Xml_Linq_XAttribute_Varigence_Flow_FlowFramework_Engine_ParserContext_">AstNamedNode.ParseAttribute(XAttribute, ParserContext)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ParseChild_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ParseChild*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_ParseChild_System_Xml_Linq_XElement_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.ParseChild(System.Xml.Linq.XElement,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseChild(XElement, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_StructureEquals_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.StructureEquals*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_StructureEquals_System_Object_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.StructureEquals(System.Object)">StructureEquals(Object)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstScopeBoundaryNode.html#Varigence_Languages_Biml_AstScopeBoundaryNode_StructureEquals_System_Object_">AstScopeBoundaryNode.StructureEquals(Object)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Validate_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Validate*"></a>
  <h4 id="Varigence_Languages_Biml_Tabular_AstTabularPartitionNode_Validate_Varigence_Flow_FlowFramework_Validation_ValidationReporter_" data-uid="Varigence.Languages.Biml.Tabular.AstTabularPartitionNode.Validate(Varigence.Flow.FlowFramework.Validation.ValidationReporter)">Validate(ValidationReporter)</h4>
