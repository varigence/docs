...
<html>
  ...
  <div class="markdown level0 summary"><p>A standard implementation of IAppBuilder </p>
</div>
  ...
  <div class="markdown level1 summary"><p>Initializes a new instance of the the type.</p>
</div>
  ...
  <div class="markdown level1 summary"><p>Contains arbitrary properties which may added, examined, and modified by
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>Returns <span class="xref">System.Collections.Generic.IDictionary&lt;TKey, TValue&gt;</span>.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>The Type argument indicates which calling convention should be returned, and
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>Returns an instance of the pipeline&apos;s entry point. This object may be safely cast to the
type which was provided</p>
  ...
  <div class="markdown level1 summary"><p>The New method creates a new instance of an IAppBuilder. This is needed to create
...
<p>To create a tangent pipeline you would first call New, followed by several calls to Use on 
...
<p>That said - all of that work is typically hidden by a middleware like Map, which will do that
for you.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>The new instance of the IAppBuilder implementation</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p>Adds a middleware node to the OWIN function pipeline. The middleware are
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>The middleware parameter determines which behavior is being chained into the
pipeline. </p>
<p>If the middleware given to Use is a Delegate, then it will be invoked with the &quot;next app&quot; in 
...
<p>If the middleware given to Use is a Type, then the public constructor will be 
...
the single &quot;next app&quot; argument, then additional values may be provided in the args array.</p>
      ...
      <tr>
        ...
        <td><p>Any additional args passed to Use will be passed as additional values, following the &quot;next app&quot;
parameter, when the OWIN call pipeline is build.</p>
<p>They are passed as additional parameters if the middleware parameter is a Delegate, or as additional
constructor arguments if the middle parameter is a Type.</p>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        <td><span class="xref">Owin.IAppBuilder</span></td>
        <td><p>The IAppBuilder itself is returned. This enables you to chain your use statements together.</p>
</td>
      </tr>
    </tbody>
  </table>
