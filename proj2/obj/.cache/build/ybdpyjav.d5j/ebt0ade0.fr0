...
<html>
  ...
  <div class="markdown level0 summary"><p>Accessors for headers, query, forms, etc.</p>
</div>
  ...
  <div class="markdown level1 summary"><p>Get the associated value from the collection.  Multiple values will be merged.
...
Returns null if the key is not present.</p>
  ...
  <div class="markdown level1 summary"><p>Get the associated values from the collection in their original format.
Returns null if the key is not present.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
