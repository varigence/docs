...
<html>
  ...
  <div class="markdown level0 summary"><p>Acts as the return value from calls to the IAuthenticationManager&apos;s AuthenticeAsync methods.</p>
</div>
  ...
  <div class="markdown level1 summary"><p>Create an instance of the result object</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p>Assigned to Identity. May be null.</p>
</td>
      </tr>
      <tr>
        ...
        <td><p>Assigned to Properties. Contains extra information carried along with the identity.</p>
</td>
      </tr>
      <tr>
        ...
        <td><p>Assigned to Description. Contains information describing the authentication provider.</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p>Contains description properties for the middleware authentication type in general. Does not
vary per request.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <div class="markdown level1 summary"><p>Contains the claims that were authenticated by the given AuthenticationType. If the authentication
type was not successful the Identity property will be null.</p>
  ...
  <div class="markdown level1 summary"><p>Contains extra values that were provided with the original SignIn call.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
