...
<html>
  ...
  <div class="markdown level0 summary"><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Extension methods for <span class="xref">Owin.IAppBuilder</span>.</p>
</div>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Inserts into the OWIN pipeline a middleware which does not have a next middleware reference.</p>
</div>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">An app that handles all requests</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <div class="markdown level1 summary"><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="2" sourceendlinenumber="2">Inserts a middleware into the OWIN pipeline.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><span class="parametername">handler</span></td>
        <td><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">An app that handles the request or calls the given next Func</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">Any additional arguments for the middleware constructor</p>
</td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
      <tr>
        ...
        <td><p sourcefile="api/Owin.AppBuilderUseExtensions.yml" sourcestartlinenumber="1" sourceendlinenumber="1">The middleware type</p>
</td>
      </tr>
    </tbody>
  </table>
