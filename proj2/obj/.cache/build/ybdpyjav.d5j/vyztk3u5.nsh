...
<html>
  ...
  <head>
    ...
    <title>Class AstScriptProjectSettingsNode
   </title>
    <meta name="viewport" content="width=device-width">
    <meta name="title" content="Class AstScriptProjectSettingsNode
   ">
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode">
  
  
  <h1 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode" class="text-break">Class AstScriptProjectSettingsNode
  </h1>
  <div class="markdown level0 summary"><p>The AstScriptProjectSettingsNode type is used to model application settings that can be leveraged by SQL Server Integration Services script projects.</p>
</div>
  ...
  <div class="inheritance">
    ...
    <div class="level3"><span class="xref">AstScriptProjectSettingsNode</span></div>
  </div>
  ...
  <h6><strong>Namespace</strong>: <a class="xref" href="Varigence.Languages.Biml.Script.html">Varigence.Languages.Biml.Script</a></h6>
  <h6><strong>Assembly</strong>: Biml.dll</h6>
  <h5 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_syntax">Syntax</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public class AstScriptProjectSettingsNode : AstNamedNode, IBindableItem, IVulcanCollectionParent, IVulcanNotifyPropertyChanged, IPropertyChangeNotificationTarget, INamedNode, IReferenceableItem, IFrameworkItem, INotifyPropertyChanged, IXObjectMappingProvider, IValidationInfo, IDataErrorInfo, INamedItem, IScopedNameIndexable</code></pre>
  </div>
  <h3 id="constructors">Constructors
  </h3>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode__ctor_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.#ctor*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode__ctor_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.#ctor(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">AstScriptProjectSettingsNode(IFrameworkItem)</h4>
  <div class="markdown level1 summary"><p>Initializes a new instance of the AstScriptProjectSettingsNode class with the specified parent node.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public AstScriptProjectSettingsNode(IFrameworkItem parentItem)</code></pre>
  </div>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_FriendlyTypeName_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.FriendlyTypeName*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_FriendlyTypeName" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.FriendlyTypeName">FriendlyTypeName</h4>
  ...
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_FriendlyTypeName">AstNamedNode.FriendlyTypeName</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_FriendlyTypeNameStatic_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.FriendlyTypeNameStatic*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_FriendlyTypeNameStatic" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.FriendlyTypeNameStatic">FriendlyTypeNameStatic</h4>
  <div class="markdown level1 summary"><p>Gets the friendly name of the type of this node</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_RenderedTypeName_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.RenderedTypeName*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_RenderedTypeName" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.RenderedTypeName">RenderedTypeName</h4>
  <div class="markdown level1 summary"><p>Gets the name of the type that will be used for this script project setting</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string RenderedTypeName { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Scope_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Scope*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Scope" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Scope">Scope</h4>
  <div class="markdown level1 summary"><p>This value specifies whether the setting is defined per-user or is shared across all users.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public ScriptProjectSettingsScope Scope { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        <td><a class="xref" href="Varigence.Languages.Biml.Script.ScriptProjectSettingsScope.html">ScriptProjectSettingsScope</a></td>
        <td></td>
      </tr>
    </tbody>
  </table>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ScopeDefaultValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ScopeDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ScopeDefaultValue" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ScopeDefaultValue">ScopeDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the Scope property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static ScriptProjectSettingsScope ScopeDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_TypeName_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.TypeName*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_TypeName" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.TypeName">TypeName</h4>
  <div class="markdown level1 summary"><p>This value specifies the name of the type of the project setting.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string TypeName { get; set; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_TypeNameDefaultValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.TypeNameDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_TypeNameDefaultValue" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.TypeNameDefaultValue">TypeNameDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the TypeName property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static string TypeNameDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Value_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Value*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Value" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Value">Value</h4>
  <div class="markdown level1 summary"><p>This value specifies the initial value of the script project setting.</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ValueDefaultValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ValueDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ValueDefaultValue" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ValueDefaultValue">ValueDefaultValue</h4>
  <div class="markdown level1 summary"><p>Gets the default value for the Value property</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public static string ValueDefaultValue { get; }</code></pre>
  </div>
  <h5 class="propertyValue">Property Value</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_BindingScopeBoundaries_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.BindingScopeBoundaries*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_BindingScopeBoundaries" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.BindingScopeBoundaries">BindingScopeBoundaries()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_BindingScopeBoundaries">AstNamedNode.BindingScopeBoundaries()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_CopyFrom_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.CopyFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_CopyFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.CopyFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences)">CopyFrom(IFrameworkItem, UnboundReferences)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate">Duplicate()</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_Duplicate">AstNamedNode.Duplicate()</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate(System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_Duplicate_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstNamedNode.Duplicate(Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">Duplicate(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstNamedNode.Duplicate(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Duplicate(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_Duplicate_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstNamedNode.Duplicate(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_DuplicateHusk_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.DuplicateHusk*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.DuplicateHusk(Varigence.Flow.FlowFramework.Model.IFrameworkItem)">DuplicateHusk(IFrameworkItem)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_DuplicateHusk_Varigence_Flow_FlowFramework_Model_IFrameworkItem_">AstNamedNode.DuplicateHusk(IFrameworkItem)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_DuplicateInto_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.DuplicateInto*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.DuplicateInto(Varigence.Flow.FlowFramework.Model.IFrameworkItem,System.Collections.Generic.Dictionary{Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Model.IFrameworkItem})">DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_DuplicateInto_Varigence_Flow_FlowFramework_Model_IFrameworkItem_System_Collections_Generic_Dictionary_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Model_IFrameworkItem__">AstNamedNode.DuplicateInto(IFrameworkItem, Dictionary&lt;IFrameworkItem, IFrameworkItem&gt;)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_EmitXmlForAction_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.EmitXmlForAction*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_EmitXmlForAction_Varigence_Flow_FlowFramework_Engine_Actions_AstEnginePropertyAction_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.EmitXmlForAction(Varigence.Flow.FlowFramework.Engine.Actions.AstEnginePropertyAction)">EmitXmlForAction(AstEnginePropertyAction)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_EmitXmlForProperty_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.EmitXmlForProperty*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_EmitXmlForProperty_System_String_System_Int32_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.EmitXmlForProperty(System.String,System.Int32)">EmitXmlForProperty(String, Int32)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlAttributeFragment_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlAttributeFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlAttributeFragment_Varigence_Utility_Common_CulturedStringBuilder_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlAttributeFragment(Varigence.Utility.Common.CulturedStringBuilder)">GetBimlAttributeFragment(CulturedStringBuilder)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlChildFragment_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlChildFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlChildFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlChildFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32)">GetBimlChildFragment(CulturedStringBuilder, Int32)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlFragment_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlFragment*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetBimlFragment(Varigence.Utility.Common.CulturedStringBuilder,System.Int32,System.Boolean)">GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_GetBimlFragment_Varigence_Utility_Common_CulturedStringBuilder_System_Int32_System_Boolean_">AstNamedNode.GetBimlFragment(CulturedStringBuilder, Int32, Boolean)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetDefaultValue_System_String_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetDefaultValue(System.String)">GetDefaultValue(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetDefaultValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetDefaultValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetDefaultValue__1_System_String_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetDefaultValue``1(System.String)">GetDefaultValue&lt;T&gt;(String)</h4>
  <div class="markdown level1 summary"><p>Retrieves the default value for the property with the name propertyName</p>
</div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetJson_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetJson*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetJson_System_Text_StringBuilder_System_Boolean__System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_System_Boolean_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetJson(System.Text.StringBuilder,System.Boolean@,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean,System.Boolean)">GetJson(StringBuilder, ref Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean, Boolean)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetPotentialParentProperties_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetPotentialParentProperties*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetPotentialParentProperties" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetPotentialParentProperties">GetPotentialParentProperties()</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetPropertyValue_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetPropertyValue*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetPropertyValue_System_String_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetPropertyValue(System.String)">GetPropertyValue(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetReflectionInfoFromXmlParsePath_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetReflectionInfoFromXmlParsePath*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetReflectionInfoFromXmlParsePath_System_String_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetReflectionInfoFromXmlParsePath(System.String)">GetReflectionInfoFromXmlParsePath(String)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetSchemaLocalName_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetSchemaLocalName*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_GetSchemaLocalName" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.GetSchemaLocalName">GetSchemaLocalName()</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_HasAnyBimlChildNodes_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.HasAnyBimlChildNodes*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_HasAnyBimlChildNodes" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.HasAnyBimlChildNodes">HasAnyBimlChildNodes()</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_MergeFrom_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.MergeFrom*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_MergeFrom_Varigence_Flow_FlowFramework_Model_IFrameworkItem_Varigence_Flow_FlowFramework_Engine_Binding_UnboundReferences_System_Boolean_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.MergeFrom(Varigence.Flow.FlowFramework.Model.IFrameworkItem,Varigence.Flow.FlowFramework.Engine.Binding.UnboundReferences,System.Boolean)">MergeFrom(IFrameworkItem, UnboundReferences, Boolean)</h4>
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ParseAttribute_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ParseAttribute*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ParseAttribute_System_Xml_Linq_XAttribute_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ParseAttribute(System.Xml.Linq.XAttribute,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseAttribute(XAttribute, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
  ...
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ParseSelf_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ParseSelf*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_ParseSelf_System_Xml_Linq_XElement_Varigence_Flow_FlowFramework_Engine_ParserContext_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.ParseSelf(System.Xml.Linq.XElement,Varigence.Flow.FlowFramework.Engine.ParserContext)">ParseSelf(XElement, ParserContext)</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <h5 class="decalaration">Declaration</h5>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">protected override void ParseSelf(XElement selfElement, ParserContext context)</code></pre>
  </div>
  <h5 class="parameters">Parameters</h5>
  <table class="table table-bordered table-striped table-condensed">
    <thead>
    ...
    <tbody>
      <tr>
        ...
        <td><span class="parametername">selfElement</span></td>
        <td></td>
      </tr>
      <tr>
        <td><span class="xref">Varigence.Flow.FlowFramework.Engine.ParserContext</span></td>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNode.html#Varigence_Languages_Biml_AstNode_ParseSelf_System_Xml_Linq_XElement_Varigence_Flow_FlowFramework_Engine_ParserContext_">AstNode.ParseSelf(XElement, ParserContext)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_StructureEquals_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.StructureEquals*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_StructureEquals_System_Object_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.StructureEquals(System.Object)">StructureEquals(Object)</h4>
  ...
  <h5 class="overrides">Overrides</h5>
  <div><a class="xref" href="Varigence.Languages.Biml.AstNamedNode.html#Varigence_Languages_Biml_AstNamedNode_StructureEquals_System_Object_">AstNamedNode.StructureEquals(Object)</a></div>
  
  
  <a id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Validate_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Validate*"></a>
  <h4 id="Varigence_Languages_Biml_Script_AstScriptProjectSettingsNode_Validate_Varigence_Flow_FlowFramework_Validation_ValidationReporter_" data-uid="Varigence.Languages.Biml.Script.AstScriptProjectSettingsNode.Validate(Varigence.Flow.FlowFramework.Validation.ValidationReporter)">Validate(ValidationReporter)</h4>
