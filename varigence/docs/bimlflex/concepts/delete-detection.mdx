...
import InclHeaderDeleteDetection from './_incl-header-delete-detection.md';
...
The name used is controlled by the following settings. These settings are part of the [**Staging Naming**](../reference-documentation/reference-documentation-settings-index#staging-naming) settings group.

* The [**Append Name Landing**](../reference-documentation/settings/AppendNameLanding) setting.  The default value is: `land`.  This appends to the Delete **Object** name
* The [**Delete Object Name Pattern**](../reference-documentation/settings/DeleteObjectNamePattern) setting.  The default value is: `@@this_DEL`.  This pattern creates the **Object** name, using the `@@this` shorthand code with the `_DEL` suffix
* The [**Delete Schema Name Pattern**](../reference-documentation/settings/DeleteSchemaNamePattern).  The default value is `@@rs`.  The `@@rs` code is the Record Source as defined in the **Connection** to which the object belongs

### Capturing Delete Detection Outcomes

The metadata column for the delete specifications is defined through the [**Row Change Type**](../reference-documentation/metadata-configurations#rowchangetype) **Configuration**.
...
The Row Change Type works the same way as any other [**Configuration**](../metadata-editors/configuration-editor) in BimlFlex, and to an extent this is configurable in BimlFlex. The defaults are:
