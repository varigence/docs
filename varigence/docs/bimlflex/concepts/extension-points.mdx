...
import InclHeaderExtensionPoint from './_incl-header-extension-point.md';
...
![Extension Points Injection Points](/img/bimlflex/bimlflex-ss-v5-extension-points-sample-flow.png "Extension Points Injection Points").
...
![Extension Point Target Attribute](/img/bimlflex/attribute-extension-point-target.png "Extension Point Target Attribute").
...
![Copy Biml](/img/bimlflex/right-click-copy-biml.png "Copy Biml")
...
![BimlFlex Target](/img/bimlflex/bimlflex-package-annotations.png "BimlFlex Target")
...
![View Designer](/img/bimlflex/right-click-view-designer.png "View Designer")
...
![View BimlScript Designer](/img/bimlflex/right-click-view-bimlscript-designer.png "View BimlScript Designer")
...
![Update Preview](/img/bimlflex/update-preview-extensionpoint-target.png "Update Preview")
