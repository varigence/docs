...
* [Setting Up a BimlStudio Project for BimlFlex](./setup-bimlstudio-project)

## Managing Data Structures

* [Using SQL Server Data Tools (SSDT) projects](./ssdt-project)
* [Generating DDL in BimlStudio](./generating-ddl)

## Build Options

* [BimlStudio Build Process](./build-bimlstudio-project)
* [Building Using the Command Line](./command-line-build)

## Development Approaches

* [Working on BimlFlex with multiple developers or teams](./concurrent-development)
* [Working with Continuous Integration (CI) and Continuous Delivery (CD)](./continuous-integration-and-delivery)
