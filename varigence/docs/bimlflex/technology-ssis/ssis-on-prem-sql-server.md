...
See [BimlFlex Initial Configuration](bimlflex-getting-started-initial-configuration) for information on creating a BimlFlex project.
...
See [BimlFlex Importing Metadata](bimlflex-concepts-importing-metadata) for more detail.
...
- See [BimlFlex Delete Detection](bimlflex-concepts-delete-detection) for more detail.
...
Objects, Columns, Parameters, and Attributes may need to be modified. For examples of changes that can be made see the [First Project Walkthrough](bimlflex-getting-started-first-project-walkthrough). For information on how to manipulate metadata see the [Metadata Editors Overview](metadata-editors-overview).

### Accelerate and Publish Stage and Persisted-Stage Metadata

Accelerate and publish the STG and PSA metadata so that the project can be build and deployed. For information on how to accelerate and publish, see the [Data Vault Accelerator](bimlflex-data-vault-accelerator).
...
To complete the DV setup in BimlFlex, accelerate all tables and publish. For information on how to accelerate and publish, see the [Data Vault Accelerator](bimlflex-data-vault-accelerator).
...
Make any necessary changes to the Business Data Vault Metadata. For more information about BDV and modeling changes that can be made, see the Business Data Vault Model section of the [First Project Walkthrough](bimlflex-getting-started-first-project-walkthrough).
