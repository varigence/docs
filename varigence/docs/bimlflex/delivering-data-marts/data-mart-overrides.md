...
>
> * [Configurations](bimlflex-configuration-editor)
> * [BimlFlex Configurations](bimlflex-metadata-configurations)
> * [Attributes](bimlflex-attribute-editor)
...
All **Configurations** are global and set in the [**Configuration Editor**](bimlflex-configuration-editor).
...
>
> * [Configuration Editor](bimlflex-configuration-editor)
>
> * [Default BimlFlex Configurations](bimlflex-metadata-configurations)
>
...
A **Configuration** can be quickly added from [**Configuration Editor**](bimlflex-configuration-editor).
...
Using the existing as a Source, [Import the Metadata](bimlflex-concepts-importing-metadata) for the Dimension.
