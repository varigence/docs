...
* [Default BimlFlex Configurations](../reference-documentation/metadata-configurations)
...
If a field supports and override it will have clickable button with the following icon (<img class="icon-inline" src="../metadata-editors/images/svg-icons/attributes.svg" /><!--![Overriding Possible Icon -icon-inline](/img/bimlflex/attributes.svg "Overriding Possible Icon")-->).
...
Don't forget to click the **Save Button** (<img class="icon-inline" src="../metadata-editors/images/svg-icons/save.svg" /><!--(![Save Icon -icon-inline](/img/bimlflex/save.svg "Save Icon")-->) to record the changes.
...
When using any entity editor that support the **Attributes Tab** the **Add** (<img class="icon-inline" src="../metadata-editors/images/svg-icons/add.svg" /><!--![Add Icon -icon-inline](/img/bimlflex/add.svg "Add Icon")-->) button can be used to create an **Attribute**.
