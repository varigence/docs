...
description: Overview of Data Vault Satellites
tags: [BimlFlex, Conceptual]
---
# Satellites

Satellites in Data Vault are the `Context` entities, that provide descriptive information (properties, attributes) for [Core Business Concepts](bimlflex-data-vault-concept-hub) and [Natural Business Relationships](bimlflex-data-vault-concept-link).
...
Driving Keys are documented in more detail here: [Data Vault Driving Keys](bimlflex-data-vault-driving-keys)
...
>
> * [Data Vault Driving Keys](bimlflex-data-vault-driving-keys)
