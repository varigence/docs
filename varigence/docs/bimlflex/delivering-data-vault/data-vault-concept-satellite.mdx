...
import SettingsSatellite from './_settings_satellite.md';

# Satellites

Satellites in Data Vault are the `Context` entities, that provide descriptive information (properties, attributes) for [Core Business Concepts](./data-vault-concept-hub) and [Natural Business Relationships](./data-vault-concept-link).
...
Driving Keys are documented in more detail here: [Data Vault Driving Keys](./driving-keys-in-data-vault)
...
* [Data Vault Driving Keys](./driving-keys-in-data-vault)
