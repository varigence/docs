...
import InclHeaderNewCustomer from '../03-user-guide/includes/_incl-header-new-customer.md';
...
![BimlFlex App Setup Pane](/img/bimlflex/bfx-new-connection.png "BimlFlex App Setup Pane")
...
Once connection has been established, a new [**Customer**](../concepts/customer) can be created. Or, an existing Customer and [**Version**](../concepts/versions) can be selected.
