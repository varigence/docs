...
![BimlFlex Parameter Editor - Grid View](/img/bimlflex/bfx-parameters-overview.png "BimlFlex Parameter Editor - Grid View")

Parameters in BimlFlex are displayed in the [**Treeview**](./treeview). Selecting any parameter will open the editor.

![BimlFlex Parameter Editor](/img/bimlflex/bfx-parameter-editor.png "BimlFlex Parameter Editor")



:::note

Detailed descriptions of all **Parameter Editor** fields and options are available in the [Reference Documentation](../reference-documentation/entities/Connection).
...
![BimlFlex Parameters Action Buttons](/img/bimlflex/bfx-parameters-action-bar.png "BimlFlex Parameters Action Buttons")
