...
import InclHeaderDashboard from './_incl-header-dashboard.md';
...
![BimlFlex Project Lineage Pane](/img/bimlflex/bfx-project-lineage-pane.png "BimlFlex Project Lineage Pane")
...
![ADF Latest Package Runs](/img/bimlflex/bfx-dashboard-latest-runs.png "ADF Latest Package Runs")
...
![Recent Connections Pane](/img/bimlflex/dashboard-recent-connections.64527.png "Connection Pane Overview")
...
![Recent Connections Pane](/img/bimlflex/dashboard-recent-connections-menu.64527.png "Connection Pane Overview")
...
![Recent Objects Pane](/img/bimlflex/bfx-dashboard-recent-objects.png "Recent Objects Pane")
...
![Recent Objects Quick Menu](/img/bimlflex/bfx-dashboard-recent-objects-quick-menu.png "Recent Objects Quick Menu")
...
![Dashboard Actions](/img/bimlflex/bimlflex-app-dashboard-actions.png "Dashboard Actions")
...
See [More info](./data-type-mappings).
...
[More info](../getting-started/sample-metadata) about the various Sample Metadata sets.
