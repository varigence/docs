...
import DialogArchiveColumnSingle from './_dialog-archive-column-single.md';
import DialogDuplicateColumn from './_dialog-duplicate-column.md';
import EnumChangeType from '../reference-documentation/static-data/_enum-change-type.md';
...
**Columns** within BimlFlex are displayed in the [**Treeview**](./treeview) on the left side-navigation menu. Columns belong to an [**Object**](./object-editor), and can be access by opening the object in the treeview or by navigating to the columns tab in the **Object Editor** .



:::note

Detailed descriptions of all **Column** fields and options are available in the [Reference Documentation](../reference-documentation/entities/Column).
...
![BimlFlex Column Editor](/img/bimlflex/bfx-columns-editor.png "BimlFlex Column Editor")
...
![BimlFlex Column Editor - Grid View](/img/bimlflex/bfx-columns-editor-listview.png "BimlFlex Column Editor - Grid View")

## Action Buttons

![Column Editor Action Buttons](/img/bimlflex/bfx-objects-action-buttons.png "Column Editor Action Buttons")
...
Detailed reference documentation on each of the fields in the column editor is found in the [Reference Documentation](../reference-documentation/entities/Column). A brief overview will be provided here.
...
The Business Overrides section contains information from the business model. Please refer to the [**Business Modeling**](./business-modeling) feature for more information about the definition of a business model. This section also specifies the data type conversion that must be applied to a column when propagating it through the data solution architecture. For example, when deriving the Staging Area or Data Vault columns.
...
<DialogArchiveColumnSingle />

<DialogDuplicateColumn />
