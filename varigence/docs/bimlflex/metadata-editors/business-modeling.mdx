...
import InclHeaderBusinessModeling from './_incl-header-business-modeling.md';
...
![Selecting a Modeling Configuration](/img/bimlflex/business-modeling-configuration.png "Selecting a Modeling Configuration")
...
![Adjusting the Modeling Configuration](/img/bimlflex/business-modeling-adjust-modeling-configuration.png "Adjusting the Modeling Configuration")
...
![Creating a second row of swimlanes](/img/bimlflex/business-modeling-second-swimlane.png "Creating a second row of swimlanes")
...
![Defining Business Subjects](/img/bimlflex/business-modeling-business-subjects.png "Defining Business Subjects")
...
![Defining Classifications](/img/bimlflex/business-modeling-classifications.png "Defining Classifications")
...
![Classifications as visible on a Business Entity](/img/bimlflex/business-modeling-classifications-on-tile.png "Classifications as visible on a Business Entity")
...
![Defining Tags](/img/bimlflex/business-modeling-tags.png "Defining Tags")
...
![Creating a Business Model](/img/bimlflex/business-modeling-add-business-model.png "Creating a Business Model")
...
![Business Model Canvas](/img/bimlflex/business-modeling-business-model-canvas.png "Business Model Canvas")
...
![Editing a Business Model](/img/bimlflex/business-modeling-edit-business-model.png "Editing a Business Model")
...
![Known-As](/img/bimlflex/business-modeling-known-as.png "Known-As")
...
![Synonyms on the Business Model Canvas](/img/bimlflex/business-modeling-known-as-outcome.png "Synonyms on the Business Model Canvas")
...
![Attributes on the Business Model Canvas](/img/bimlflex/business-modeling-attribute-outcome.png "Attributes on the Business Model Canvas")
...
![Editing a Business Entity](/img/bimlflex/business-modeling-edit-business-entity.png "Editing a Business Entity")
...
![Editing a Business Entity](/img/bimlflex/business-modeling-business-entity-editor-main.png "Editing a Business Entity")
...
![Viewing the Business Attributes for a Business Entity](/img/bimlflex/business-modeling-business-entity-editor-attributes.png "Viewing the Business Attributes for a Business Entity")
...
![Viewing the relationships for a Business Entity](/img/bimlflex/business-modeling-business-entity-editor-relationships.png "Viewing the Business Attributes for a Business Entity")
...
![Editing a Business Entity in the side panel](/img/bimlflex/business-modeling-business-entity-side-panel.png "Editing a Business Entity in the side panel")
...
![Business Attribute Editor](/img/bimlflex/business-modeling-business-attribute-editor.png "Business Attribute Editor")
...
![Business Entity Relationship Editor](/img/bimlflex/business-modeling-relationship-editor.png "Business Entity Relationship Editor")
...
![Event Matrix Overview](/img/bimlflex/business-modeling-event-matrix.png "Event Matrix Overview")
...
![Editing an Event Matrix](/img/bimlflex/business-modeling-edit-event-matrix.png "Editing an Event Matrix")
...
![A Business Model Diagram in BimlFlex](/img/bimlflex/business-modeling-diagram-example.png "A Business Model Diagram in BimlFlex")
...
![Creating a new Business Model Diagram](/img/bimlflex/business-modelling-create-new-diagram.png "Creating a new Business Model Diagram")
...
![Diagram Treeview](/img/bimlflex/business-modeling-diagram-treeview.png "Diagram Treeview")
...
![Editing Business Entities from the Business Model Diagram](/img/bimlflex/business-modeling-diagram-side-panel.png "Editing Business Entities from the Business Model Diagram")
...
![Creating a new relationship](/img/bimlflex/business-modeling-diagram-new-relationship.png "Creating a new relationship")
...
![Editing a relationship](/img/bimlflex/business-modeling-diagram-relationship-editor.png "Editing a relationship")
...
![Creating a Keyed Instance](/img/bimlflex/business-modeling-diagram-keyed-instance.png "Creating a Keyed Instance")
...
![Reviewing a Keyed Instance](/img/bimlflex/business-modeling-diagram-keyed-instance-outcome.png "Reviewing a Keyed Instance")