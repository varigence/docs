...
import DialogArchiveAttributeSingle from './_dialog-archive-attribute-single.md';
import DialogDuplicateAttribute from './_dialog-duplicate-attribute.md';
import InclHeaderAttribute from './_incl-header-attribute.md';
import EnumAttributeType from '../reference-documentation/static-data/_enum-attribute-type.md';
...
![BimlFlex - Attribute Editor](/img/bimlflex/bfx-attributes-editor-overview.png "BimlFlex - Attribute Editor")



:::note

Detailed descriptions of all **Attribute Editor** fields and options are available in the [Reference Documentation](../reference-documentation/reference-documentation-entities-index).
...
![BimlFlex Attribute Editor - Action Buttons](/img/bimlflex/bfx-attributes-action-buttons.png "BimlFlex Attribute Editor - Action Buttons")
...
<DialogArchiveAttributeSingle />

<DialogDuplicateAttribute />
