...
![Archive Multiple Objects Dialog -mtb-20-image](/img/bimlflex/bimlflex-app-dialog-archive-object-list.png "Archive Multiple Objects Dialog")
...
See the [Objects Editor](./object-editor) for further details on creating or editing an **Object** along with details on individual property values.
...
| ---------------- | -------------------------------------------------------------------- | ------------------------------------------- |
| Project            | Value                | The **Project** that the **Object** belongs to. See [Projects Documentation](./project-editor).|
...
| Exclude Build      | Checkbox (Y/N)       | Toggle to determine whether the **Object** is excluded from the [build](../build-and-deployment) when the BimlFlex solution is compiled.|
...
| Item             | Action                                                               |
| ---------------- | -------------------------------------------------------------------- |
| Project Value   | Navigate to the [**Project Editor**](./project-editor) by clicking <img class="icon-inline" src="images/svg-icons/navigate.svg" style={{ width: '18px' }}/>       |
| Object Value     | Navigate to the [**Object Editor**](./object-editor), selecting the clicked **Object**|
...
Functionality on the below forms however is consistent: click the **Object** name to navigate to the selected **Object** in the [Object Editor](./object-editor).
...
The **Model Overrides** view allows for quick management of metadata configured through the [Data Vault Accelerator](./accelerator), [Business Modeling](./business-modeling) or the [Schema Diagram](./schema-diagram). This view is intended as an easy way to review, reference, and maintain previously entered metadata.
...
| Component              | Type                 | Description                        |
| ---------------- | -------------------------------------------------------------------- | ------------------------------------------- |
| Object            | Navigational Value                | The name of the **Objects** as associated with the current **Connection**. See the [Object Editor](./object-editor) documentation for more details.|
| Accelerator Type            | Value                | The type of entity the target **Object** will be defined as for the Data Vault Accelerator. This information will determine to what Data Vault entity type this object will be mapped. See [Data Vault Accelerator Documentation](./accelerator) for more details. |
| Business Entity | Value | Displays the Business Entity that is associated with this **Object**. Use Business Modeling to define the Business Entities. See [Business Modeling Documentation](./business-modeling). |
...
| Business Subject     | Value       | Displays the Business Subject to which this **Objects** is added. A Business Subject is an additional way to classify Business Entities. A Business Subject may contain multiple Business Entities. Each Business Entity can be associated with a single Business Subject. See [Business Modeling Documentation](./business-modeling). |



:::danger

Although it is possible to manage high level metadata from this screen, it is recommended to you use the [Data Vault Accelerator](./accelerator) for implementing changes in the design. The [Data Vault Accelerator](./accelerator) is specifically designed to simplify and improve the experience of modeling metadata via a graphical designer as opposed to the table entry that this view provides.
...
| Component              | Type                 | Description                        |
| ---------------- | -------------------------------------------------------------------- | ------------------------------------------- |
| Object            | Navigational Value                | The name of the **Objects** as associated with the current **Connection**. See the [Objects Editor](./object-editor) documentation for more details.|
...
See the [Objects Editor](./object-editor) documentation for additional information on the above fields and more.
