...
description: Documentation regarding the Columns Tab
tags: [BimlFlex, Reference]
---

import DialogAddColumn from './_dialog-add-column.md';
import DialogArchiveColumnList from './_dialog-archive-column-list.md';
import DialogGenerateDerivedIntegrationKey from './_dialog-generate-derived-integration-key.md';
...
<DialogArchiveColumnList />  

<DialogGenerateDerivedIntegrationKey />  
