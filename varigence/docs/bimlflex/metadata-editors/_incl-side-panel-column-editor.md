![Column Editor Side Panel](images/side-panel-column-editor.png "Column Editor Side Panel")

>[!NOTE]
>The editable information in the side panel is the same as per the [**Column Editor**](bimlflex-column-editor). For more information on this please refer there.
...
| N/A | Actions (menu) | Context-sensitive menu of actions. For **Object** actions, please refer to the **Object Editor**(bimlflex-object-editor).|
