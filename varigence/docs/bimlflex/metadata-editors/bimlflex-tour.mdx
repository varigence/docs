...
import InclToolbar from './_incl-toolbar.md';
...
![BimlFlex Menu](/img/bimlflex/bfx-navigation-menu-01.png "BimlFlex Menu")
...
![BimlFlex Editor](/img/bimlflex/bfx-metadata-editor-layout.png "BimlFlex Editor")
...
The Editor Action Buttons are always located on the top of the screen, just under the [BimlFlex Toolbar](./bimlflex-tour#bimlflex-toolbar).
...
The [**Treeview**](./treeview) provides an overview of existing components relative to the selected editor, and quick access to common features for managing the selected component.
...
For additional information on the [**Treeview**](./treeview), including the **Search** and **Filtering** options, please refer to the [**Treeview Documentation**](./treeview).
...
![Tab List](/img/bimlflex/bfx-tabs.png "Tab List")
...
![Fields Content](/img/bimlflex/bfx-fields-content.png "Fields Content")
...
![Editor Dialog Button](/img/bimlflex/dialog-editor-button.64566.png "Editor Dialog Button")
...
![Editor Dialog](/img/bimlflex/dialog-editor.64566.png "Editor Dialog")
...
![Table Content](/img/bimlflex/bfx-biml-tour-table-record.png "Table Content")
...
![Multiple Views Content](/img/bimlflex/bfx-multiple-views-content.png "Multiple Views Content")
...
![Filter Dialog](/img/bimlflex/bfx-filter-dialog.png "Filter Dialog")
...
![Navigational Transitions](/img/bimlflex/bfx-navigation-ui.png "Navigational Transitions")
