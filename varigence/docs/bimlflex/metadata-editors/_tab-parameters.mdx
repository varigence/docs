...
![Add Parameter Dialog - mtb-20-image](/img/bimlflex/bimlflex-app-dialog-add-parameter.png "Add Parameter Dialog")
...
![Edit Parameter Dialog -mtb-20-image](/img/bimlflex/bimlflex-app-dialog-edit-parameter.png "Edit Parameter Dialog")
...
![Archive Multiple Parameters Dialog - mtb-20-image](/img/bimlflex/bimlflex-app-dialog-archive-parameter-list.png "Archive Multiple Parameters Dialog")
...
| ---------------- | -------------------- | ---------------------------------- |
| Object           | Value                | The name of the **Object** within the current Source **Connection**. See [Objects Documentation](./object-editor).|
| Column           | Value                | The name of the **Column** within the current entity. See [Columns Documentation](./column-editor).|
| Parameter        | Navigational Value   | The name of the **Parameter** that is being applied to the selected entity. See [Parameters Documentation](./parameter-editor).  |
...
| Data Type        | Value                | The data type to use for the **Parameter**.  Must be a valid data type. See [Valid Data Types](../reference-documentation/metadata-static-values#data-types). |
...
|Item|Action|
|-|-|
|Object|Navigate to [**Object Editor**](./object-editor), by clicking <img class="icon-inline" src="images/svg-icons/navigate.svg" style={{ width: '18px' }}/> |
|Column|Navigate to [**Column Editor**](./column-editor), by clicking <img class="icon-inline" src="images/svg-icons/navigate.svg" style={{ width: '18px' }}/> |
|Name|Navigate to [**Parameter Editor**](./parameter-editor), selecting the clicked **Parameter**|
