...
import InclHeaderSetting from './_incl-header-setting.md';
...
The [Settings Reference Documentation](../reference-documentation/reference-documentation-settings-index) serves as a complete guide for all settings available in the BimlFlex App.

:::


![Setting Editor](/img/bimlflex/settings-editor.png "Settings Editor")
...
![Tooltips](/img/bimlflex/settings-floating-tool-tip.png "Tooltips")
...
![Search Bar Tool Tip](/img/bimlflex/search-tool-tip.png "Search Bar Tool Tips")
...
![Search Term Highlight](/img/bimlflex/search-highlight.gif "Search Term Highlight")
...
![BimlFlex App - Settings - Command Bar](/img/bimlflex/bfx-settings-command-bar.png "BimlFlex App - Settings - Command Bar")
...
![Settings Overrides](/img/bimlflex/bimlflex-app-settings-overrides.64566.png "Settings Overrides")
...
Setting Overrides are saved in BimlFlex as **Attributes**. The [**Attribute Editor documentation**](./attribute-editor) provides information on attributes and how to manage them.
...
![Adding a setting override](/img/bimlflex/bfx-setting-editor-overrides.png "Adding a setting override")
...
Alternatively, as setting overrides are managed as **Attributes** in BimlFlex, it is possible to manage them from the **Attribute Editor**. Please refer to the [Attribute Editor](./attribute-editor) documentation for additional information.
