...
description: Documentation of functionality within BimlFlex for Connections
tags: [BimlFlex, Reference]
---

# Connections

The BimlFlex [**Connections**](bimlflex-connection-editor) provide the information required to connect to data sources. Connections are also used as containers for objects and allow setting overrides. Additionally, Connections contain metadata to identify the integration stage along with data logistics execution settings.
