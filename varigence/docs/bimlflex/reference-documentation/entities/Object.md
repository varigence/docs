...
description: Documentation of functionality within BimlFlex for Objects
tags: [BimlFlex, Reference]
---

# Objects

Objects in BimlFlex are the data stores that can be used as source, or target, for data logistics. Objects are managed in the [**Object Editor**](bimlflex-object-editor).

An Object can be a database table, a flat file, Excel documents, and, via use of [**Extensions Points**](bimlflex-concepts-extension-points), APIs calls.
