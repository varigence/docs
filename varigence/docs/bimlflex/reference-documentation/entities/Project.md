...
description: Documentation of functionality within BimlFlex for Projects
tags: [BimlFlex, Reference]
---

# Projects

The BimlFlex [**Project**](bimlflex-project-editor) concept defines a data logistics workload.<br/><br/>Projects specify the primary orchestration engine (SSIS or ADF) and define the [**Connections**](bimlflex-connection-editor) for the Source to Target pipeline.
