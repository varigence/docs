...
The BimlFlex [**Project**](../../metadata-editors/project-editor) concept defines a data logistics workload.<br/><br/>Projects specify the primary orchestration engine (SSIS or ADF) and define the [**Connections**](../../metadata-editors/connection-editor) for the Source to Target pipeline.
