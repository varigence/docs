...
The BimlFlex [**Version**](../../concepts/versions) concept supports management of changes in metadata over time. These changes are managed in Versions.
    A Version is part of a BimlFlex [**Customer**](../../concepts/customer), and a Customer can contain many (one or more) versions of the metadata.
