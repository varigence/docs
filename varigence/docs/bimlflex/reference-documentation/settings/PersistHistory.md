...
Provides an option to override the [Connection](bimlflex-app-reference-documentation-Connections) level attribute "PersistHistory" for more granular control.
