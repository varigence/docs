...
import InclHeaderAccelerator from '../03-user-guide/includes/_incl-header-accelerator.md';
import InclHeaderAttribute from '../03-user-guide/includes/_incl-header-attribute.md';
import InclHeaderBatch from '../03-user-guide/includes/_incl-header-batch.md';
import InclHeaderBimlflexApp from '../03-user-guide/includes/_incl-header-bimlflex-app.md';
import InclHeaderBusinessModeling from '../03-user-guide/includes/_incl-header-business-modeling.md';
import InclHeaderConfiguration from '../03-user-guide/includes/_incl-header-configuration.md';
import InclHeaderConnection from '../03-user-guide/includes/_incl-header-connection.md';
import InclHeaderDashboard from '../03-user-guide/includes/_incl-header-dashboard.md';
import InclHeaderObject from '../03-user-guide/includes/_incl-header-object.md';
import InclHeaderParameter from '../03-user-guide/includes/_incl-header-parameter.md';
import InclHeaderProject from '../03-user-guide/includes/_incl-header-project.md';
import InclHeaderSchemaDiagram from '../03-user-guide/includes/_incl-header-schema-diagram.md';
import InclHeaderSetting from '../03-user-guide/includes/_incl-header-setting.md';
