...
import InclHeaderAccelerator from '../user-guide/includes/_incl-header-accelerator.md';
import InclHeaderAttribute from '../user-guide/includes/_incl-header-attribute.md';
import InclHeaderBatch from '../user-guide/includes/_incl-header-batch.md';
import InclHeaderBimlflexApp from '../user-guide/includes/_incl-header-bimlflex-app.md';
import InclHeaderBusinessModeling from '../user-guide/includes/_incl-header-business-modeling.md';
import InclHeaderConfiguration from '../user-guide/includes/_incl-header-configuration.md';
import InclHeaderConnection from '../user-guide/includes/_incl-header-connection.md';
import InclHeaderDashboard from '../user-guide/includes/_incl-header-dashboard.md';
import InclHeaderObject from '../user-guide/includes/_incl-header-object.md';
import InclHeaderParameter from '../user-guide/includes/_incl-header-parameter.md';
import InclHeaderProject from '../user-guide/includes/_incl-header-project.md';
import InclHeaderSchemaDiagram from '../user-guide/includes/_incl-header-schema-diagram.md';
import InclHeaderSetting from '../user-guide/includes/_incl-header-setting.md';
