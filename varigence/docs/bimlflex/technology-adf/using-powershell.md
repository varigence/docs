...
For a walk-through of creating a BimlFlex solution that targets ADF, review the [Synapse ADF Implementation Guide](../technology-synapse/synapse-implementation).
-->
