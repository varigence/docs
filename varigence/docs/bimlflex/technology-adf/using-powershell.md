...
For a walk-through of creating a BimlFlex solution that targets ADF, review the [Synapse ADF Implementation Guide](bimlflex-synapse-implementation).
-->
...
1. Create the Trigger in BimlFlex through an [Extension Point](bimlflex-concepts-extension-points).
