...
![Parameters ETL Pattern](../static/img/bfx-parameters-architecture-ssis.png "Parameters ETL Pattern")
...
<!-- ![Parameters ETL Pattern](../static/img/bfx-parameters-architecture-adf.png "Parameters ETL Pattern") -->
...
More information: [BimlFlex Extension Points](xref:bimlflex-concepts-extensionpoints)

![Create Project Parameter](../static/img/bimlflex-ss-v5-extension-points-create-project-parameter.png "Create Project Parameter")
...
![Create Package Parameter](../static/img/bimlflex-ss-v5-extension-points-create-package-parameter.png "Create Package Parameter")
