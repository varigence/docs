...
BimlFlex has been updated to incorporate Databricks functionality, enhancing its capabilities in data management and prcoessing. The integration of these two solutions results in a robust environment for data mangement, providing users with a seamless and efficient means to unlock the potential of their data, including capabilities related to Data Mesh, Data Vault, and Data Mart archictures.
...
* **Description**: Introduces specialized Data Mart templates that are optimized for Databricks, offering seamless integration and enhanced performance. The existing DataMart feature has been refactored to better align with the unique capabilities of  atabricks.
...
The BimlFlex Documentation generator is a comprehensive tool designed to streamline the creation and deployment of organization-specific documentation for its data solutions.
...
* Added new diagram display options, available in all graphical metadata editors:
  ...
  * Removed dropdown arrow on object. Users cannot individually hide the columns on certain objectws when 'Show Columns' is active (this is a regression).
...
<!-- 
CJSxxx -- what circumstances? can expand bullet point
-->
