...
> For a details and considerations on implementing CI/CD in ADF see the [BimlFlex CI/CD for ADF](xref:bimlflex-adf-continuous-integration-and-continuous-delivery).
