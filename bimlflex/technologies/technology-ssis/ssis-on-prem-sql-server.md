...
![BimlStudio - Set Project Target Architecture](../../static/img/bfx-ssis-src-stg-psa-SetProjectTargetVersions.png)
...
![Open Project in Visual Studio](../../static/img/bfx-ssis-src-stg-psa-LoadSampleMetadata.png)
...
![Import Metadata](../../static/img/bfx-ssis-src-stg-psa-ImportMetadata.png)
...
![Set Global Delete Detection](../../static/img/bfx-ssis-src-stg-psa-SetGlobalDeleteDetection.png)
...
![Grab Create Table Scripts](../../static/img/bfx-ssis-src-stg-psa-CreateScripts.png)

Deploy Create Table Scripts

![Deploy Create Table Scripts](../../static/img/bfx-ssis-src-stg-psa-DeployCreateTableScripts.png)

BimlStudio: Build SSIS packages for the target version

![Build Package](../../static/img/bfx-ssis-src-stg-psa-BuildPackage.png)
...
![Open Project in Visual Studio](../../static/img/bfx-ssis-src-stg-psa-OpenProjectInVisualStudio.png)

#### Test run SSIS packages (Run 01_EXT_AWLT_SRC_Batch.dtsx), validate data loaded to target

![Run SSIS Package](../../static/img/bfx-ssis-src-stg-psa-Run-SSIS-Package.png)
...
1. Navigate to **Connections**  
  ![ssis-op-sql-menu-connections.png](../../static/img/ssis-op-sql-menu-connections.png)
1. Select the BFX_DV Connection  
  ![ssis-op-sql-connections-list.png](../../static/img/ssis-op-sql-connections-list.png)
1. Change the Connection Type to "OLEDB" or "OLEDB with ELT" and save  
  ![ssis-op-sql-connections-save.png](../../static/img/ssis-op-sql-connections-save.png)
...
1. Click the BimlFlex tab.  
  ![BimlFlex Menu Bar](../../static/img/ssis-op-sql-deploy-1.png "BimlFlex Menu Bar")
...
1. Click the ![Script Options Button](../../static/img/ssis-op-sql-create-script-options-button.png "Script Options Button") button to access the Script Options Dialog.  
  ![Script Options Dialog](../../static/img/ssis-op-sql-deploy-2.png "Script Options Dialog")
1. Under Integration Stages click the dropdown  
  ![Default Integration Selections](../../static/img/ssis-op-sql-deploy-3.png "Default Integration Selections")
1. Click the `None` checkbox to clear selections  
  ![Select None](../../static/img/ssis-op-sql-deploy-4.png "Select None")
1. Click the `Business Data Vault` checkbox.  
  ![Select BDV](../../static/img/ssis-op-sql-deploy-5.png "Select BDV")
1. Click `Commit`  
1. Click the *Generate Scripts* button to show the dropdown menu.  
  ![Generate Scripts Dropdown](../../static/img/ssis-op-sql-deploy-6.png "Generate Scripts Dropdown")
...
1. Back in BimlStudio click the [Build & Deploy] tab.  
  ![Build & Deploy Menu](../../static/img/ssis-op-sql-deploy-7.png "Build & Deploy Menu")
...
1. Navigate to the  Solution Explorer on the right.  
  ![Visual Studio Solution Explorer](../../static/img/ssis-op-sql-ssdt-1.png "Visual Studio Solution Explorer")
1. Right-Click the project `BFX_DV`.  
  ![Right Click Project](../../static/img/ssis-op-sql-ssdt-2.png "Right Click Project")
1. Select *Publish...* to get the Publish Database dialog box.  
  ![Publish Database Dialog](../../static/img/ssis-op-sql-ssdt-3.png "Publish Database Dialog")
1. Configure your *Target database connection* by clicking **Edit** to get the Connect dialog box.  
  ![image.png](../../static/img/ssis-op-sql-ssdt-4.png)
1. In the Connect dialog box expand the Connection Properties by clicking *Show Connection Properties*.  
  ![Connection Properties](../../static/img/ssis-op-sql-ssdt-5.png)
...
1. Click **OK**.  
1. Click **Publish**  
   ![Publish](../../static/img/ssis-op-sql-ssdt-6.png)
1. The Data Tools Operations window should appear.  
   ![Data Tools](../../static/img/ssis-op-sql-ssdt-7.png)
1. Wait for deployment to complete.  
   ![Deployment Complete](../../static/img/ssis-op-sql-ssdt-8.png)
