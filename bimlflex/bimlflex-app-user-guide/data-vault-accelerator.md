...
|<div style="width:30px; height:30px;background:white;"><img src="images\svg-icons\split-columns.svg"/></div>| <span style="white-space:nowrap">Spit</span> | Preview action to split columns from a Satellite. |
