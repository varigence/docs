...
|[Default Schema](xref:bimlflex-reference-documentation-setting-DvDefaultSchema) |![Text Datatype](../static/svg/text.svg "Text Datatype")|The default schema to use for the Data Vault.|
