...
![Create Catalog](../../static/img/ssms-ssis-context-menu-create-catalog.png "Create Catalog")
...
![Create Environment](../../static/img/ssms-ssis-context-menu-create-environment.png "Create Environment")
...
![Create Environment Dialog](../../static/img/ssms-ssis-dialog-create-environment.png "Create Environment")
...
![Environment Properties](../../static/img/ssms-ssis-dialog-environment-properties.png "Environment Properties")
...
> [!TIP]
> For additional details please refer to the below guide [BimlFlex SSIS Custom Components](xref:bimlflex-ssis-custom-components) guide.  
...
![BimlStudio Project Properties](../../static/img/bs-menu-project-configuration.png "BimlStudio Project Properties")

> [!TIP]
> For additional details on configuring a BimlStudio project please refer to the [BimlStudio Project Setup](xref:bimlflex-setup-bimlstudio-project) guide.
...
> [!TIP]
> For additional details on importing metadata project refer to the [BimlFlex Metadata Import](xref:bimlflex-concepts-importing-metadata) guide.

### Step 4: Create Databases and Tables

Create all DW databases and tables from the BimlStudio generated scripts output.

![BimlStudio - Create Table Scripts](../../static/img/bs-context-menu-create-table-scripts.png "BimlStudio - Create Table Scripts")

> [!TIP]
> For additional details on generating the DDL refer to the below guide [BimlFlex DDL Generation](xref:bimlflex-generating-ddl) guide.
...
![BimlStudio - Build Project](../../static/img/bs-menu-build.png "BimlStudio - Build Project")
...
![Build Output Folder](../../static/img/bimlstudio-build-output-folder.png "Build Output Folder")
...
![Deployment Options for SSIS](../../static/img/isdeploymentwizard-deployment-options.png "Deployment Options for SSIS")
...
![SSDT UI](../../static/img/ssdt-2015-batch-file.png "SSDT UI")

![Target Server Version](../../static/img/ssdt-2015-menu-project-properties-target-server-version.png "Target Server Version")
...
![Catalog Contents](../../static/img/ssms-ssis-tree-catalog-contents.png "Catalog Contents")

## Configuring the Environment and connecting the project to it

Once the project is in the Catalog it can be configured.

![Configure Catalog](../../static/img/ssms-ssis-context-menu-catalog-configure.png "Configure Catalog")
...
![Associate Environment to Project](../../static/img/ssms-ssis-dialog-browse-environments.png "Associate Environment to Project")
...
![Environment Variable](../../static/img/ssms-ssis-dialog-set-parameter-value.png "Environment Variable")
...
![Parameter Required](../../static/img/ssms-ssis-dialog-execute-package.png "Parameter Required")
...
![Agent Configuration](../../static/img/ssms-agent-dialog-new-job-step.png "Agent Configuration")
