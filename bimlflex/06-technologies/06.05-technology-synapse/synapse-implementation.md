...
- [AzCopy\Paths](xref:bimlflex-reference-documentation-settings-index)
  - Configures location of AzCopy and Log Location
- [AzCopy\Settings](xref:bimlflex-reference-documentation-settings-index)
...
- [SSDT\Synapse SSDT Artifacts](xref:bimlflex-reference-documentation-settings-index)
...
- (*OPTIONAL*) [Azure\Deployment](xref:bimlflex-reference-documentation-settings-index)
...
Through use of [SSDT\Synapse SSDT Artifacts Settings](xref:bimlflex-reference-documentation-settings-index) EXTERNAL TABLES can be included or excluded in this deployment file.
