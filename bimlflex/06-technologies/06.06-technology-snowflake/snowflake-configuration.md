...
The following Snowflake [**Snowflake-specific settings**](xref:bimlflex-reference-documentation-settings-index#snowflake) are used to configure overall orchestration options for Snowflake.
