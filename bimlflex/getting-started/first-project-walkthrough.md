...
Using these source definitions, BimlFlex can provide a started Data Vault model using the [**Data Vault Accelerator**](xref:bimlflex-data-vault-accelerator).

## Data Vault Acceleration

The BimlFlex App provides a [Data Vault Accelerator](xref:bimlflex-data-vault-accelerator) that creates Data Vault objects from the available source metadata.
