...
* The [*Append Hub*](xref:bimlflex-reference-documentation-setting-DvAppendHub) setting in the *Data Vault Naming* setting category contains the label which will be added to a new Hub **Object**, for example 'HUB'
* Whether the above label will be added as a `Prefix` or `Suffix` is managed in the [*Suffix or Prefix Object*](xref:bimlflex-reference-documentation-setting-SuffixOrPrefixObject) setting which is found in the *Naming* setting category
...
![Defining a new Hub Object](../../static/img/hub-manual-create-object.png "Defining a new Hub Object")
...
![Creating a Hub Mapping](../../static/img/hub-manual-create-mapping.png "Creating a Hub Mapping")
...
This is controlled using the The [*Infer Link Hub*](xref:bimlflex-reference-documentation-setting-DvInferLinkHub) setting in the *Data Vault* setting category. By default, this will be disabled and BimlFlex will manage the order of load dependency to avoid Referential Integrity issues.
...
The [*Use Hash Keys*](xref:bimlflex-reference-documentation-settings-index) setting can be used to toggle between using a hashed or natural **Integration Key**. Integrate without a `Hash` which is very efficient for modern data warehouse solutions like [Snowflake](https://www.snowflake.com/) and [Azure Synapse](https://azure.microsoft.com/en-us/services/synapse-analytics/).
