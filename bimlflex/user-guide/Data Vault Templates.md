...
The Data Vault can be accelerated using the BimlFlex Data Vault Accelerator that is [described in its own document](Data%20Vault%20Accelerator). This document focuses on the process of manually creating Data Vault artifacts by manipulating metadata.

## Setup

This document assumes the BimlFlex product has been [installed](Developer%20Installation) and [configured](Initial%20Setup%20and%20Configuration) and that the [AdventureWorksLT](https://msftdbprodsamples.codeplex.com/) sample metadata is ready to be imported to a new empty customer.
...
![Import Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_import_metadata_product.png "Import Metadata")
...
![Hub Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_hub_metadata_objects.png "Hub Metadata")
...
![Hub Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_hub_metadata_columns.png "Hub Metadata")
...
![Hub Load Pattern](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_hub_load_pattern.png "Hub Load Pattern")
...
![Link Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_link_metadata_objects.png "Link Metadata")
...
![Link Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_link_metadata_columns.png "Link Metadata")
...
![Link Load Pattern](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_link_load_pattern.png "Link Load Pattern")
...
![Satellite Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_satellite_metadata_objects.png "Satellite Metadata")
...
![Satellite Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_satellite_metadata_columns.png "Satellite Metadata")

Illustrated here is the Satellite load flow

![Satellite Process flow](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_satellite_load_pattern.png "Satellite Process flow")
...
![Driving Key Metadata](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_excel_driving_key_metadata_attributes.png "Driving Key Metadata")
...
Multi Active Satellites are created by adding multiple Keys to the Satellite definition.

Multi Active Satellites break the formal Data Vault design and modeling pattern and it is recommended to use the default patterns if possible. An extra Hub roleplaying the Multi Active attribute can be added to the UOW/Link to implement a similar behavior. 

For sources that have multiple changes to the same row at the same time it is easier to define the order and override the effective from datetime to reflect that order instead of implementing Multi Activeness.
...
![Data Vault Hub ETL Pattern](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_staging_to_data_vault_hub_etl_pattern.png "Data Vault Hub ETL Pattern")

This package only includes the Hub entity load of the `HUB_Product` destination.

**Full ETL flow sample**

![Data Vault ETL Pattern](https://varigencecom.blob.core.windows.net/walkthroughs/bimlflex_ss_v5_staging_to_data_vault_full_etl_pattern.png "Data Vault ETL Pattern")
