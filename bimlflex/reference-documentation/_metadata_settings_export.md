...
| Type | Setting | Description | Permitted |
| ---- | ------- | ----------- | --------- |
...
| Type | Setting | Description | Permitted |
| ---- | ------- | ----------- | --------- |
| ![Text Datatype](images\svg-icons\text.svg "Text Datatype") | Hash Algorithm | The hashing algorithm to use. ("MD5"/"SHA1"/"SHA2_256"/"SHA2_512") | [![Go To Permitted Values](images\svg-icons\permitted-values.svg "Go To Permitted Values")](#tab/core-hash-permitted-hashalgorithm) |
...
| ![Text Datatype](images\svg-icons\text.svg "Text Datatype") | Constraint Mode DV | The table reference constraint mode to apply for the DV (Data Vault) database ("DoNotCreate", "CreateAndNoCheck", "CreateAndCheck") | [![Go To Permitted Values](images\svg-icons\permitted-values.svg "Go To Permitted Values")](#tab/orchestration-constraints-permitted-constraintmodedv) |
| ![Text Datatype](images\svg-icons\text.svg "Text Datatype") | Constraint Mode DM | The table reference constraint mode to apply for the DM (Data Mart) database ("DoNotCreate", "CreateAndNoCheck", "CreateAndCheck") | [![Go To Permitted Values](images\svg-icons\permitted-values.svg "Go To Permitted Values")](#tab/orchestration-constraints-permitted-constraintmodedm) |
...
| ![Text Datatype](images\svg-icons\text.svg "Text Datatype") | Scale Up Size | What size should the Snowflake Warehouse be scale up to | [![Go To Permitted Values](images\svg-icons\permitted-values.svg "Go To Permitted Values")](#tab/snowflake-process-permitted-scaleupsize) |
...
| ![Text Datatype](images\svg-icons\text.svg "Text Datatype") | Scale Down Size | What size should the Snowflake Warehouse be scale down to | [![Go To Permitted Values](images\svg-icons\permitted-values.svg "Go To Permitted Values")](#tab/snowflake-process-permitted-scaledownsize) |
