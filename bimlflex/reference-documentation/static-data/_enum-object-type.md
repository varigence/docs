---
uid: bimlflex-metadata-static-values-object-types
title: Object Types
...
| Hierarchy Link         | HAL |  |  |  |
| Hub | HUB | Defines the object as a Data Vault Hub entity. | Business Data Vault, Raw Data Vault | All |
...
| Link | LNK | Defines the object as a Data Vault Link entity. | Business Data Vault, Raw Data Vault | All |
| Link Satellite | LSAT | Defines the object as a Data Vault Link-Satellite entity. | Business Data Vault, Raw Data Vault | All |
| Point In Time | PIT | Defines the object as a Data Vault Point-In-Time (PIT) entity. | Business Data Vault, Raw Data Vault | All |
| Reference | REF | Determines that this object will be generated as a stand-alone historized table in a Data Vault context. | Business Data Vault, Raw Data Vault | All |
...
| Satellite | SAT | Defines the object as a Data Vault Satellite entity. | Business Data Vault, Raw Data Vault | All |
...
| Staged Query | STQ | Defines the object as an object that is derived from other existing objects. This will be treated as a data source, but no Staging Area and/or Persistent Staging Area components will be generated. For more details, please refer to the [Staged Query Concept](xref:bimlflex-concepts-staged-query). | Source System | Azure SQL Database, Azure Synapse, Microsoft SQL Server, Snowflake Data Warehouse |
| Table | TBL | This is the default object type in BimlFlex. A `Table` property for the object means that no specific behaviour is applied by the BimlFlex code generation processes. | Business Data Vault, Landing Area, Master Data Services, Persistent Staging Area, Raw Data Vault, Source System, Staging Area | Azure Synapse, COZYROC Excel File, COZYROC Salesforce, DB2, Dynamics CRM, Microsoft SQL Server, MySql, Oracle, Oracle RDB, PostgreSQL, Salesforce, Salesforce Marketing Cloud, Salesforce Service Cloud, Snowflake Data Warehouse, Sybase, Teradata |
