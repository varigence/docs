...
The Business Modeling feature is accessible from the main BimlFlex side menu in the [BimlFlex App](xref:metadata-editors-overview), under the 'Modeling' section.
