...
![Archive Multiple Objects Dialog -mtb-20-image](../../static/img/bimlflex-dialog-archive-object-list.png "Archive Multiple Objects Dialog")
...
<img
    src="../../static/img/bimlflex-tab-objects-view-overview.png"
    class="border-image"
    style="border:1px solid #CCC;"
...
| ---------------- | -------------------------------------------------------------------- | ------------------------------------------- |
| Project            | Value                | The **Project** that the **Object** belongs to. See [Projects Documentation](xref:bimlflex-project-editor).|
...
| Object Type        | Value                | The type of **Object** that is being extracted or created. See [Valid Object Types](../../07-reference-documentation/static-data/_enum-object-type.md).|
...
| Exclude Build      | Checkbox (Y/N)       | Toggle to determine whether the **Object** is excluded from the [build](xref:bimlflex-build-solution-overview) when the BimlFlex solution is compiled.|
