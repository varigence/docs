...
![Azure SQL Database Linked Service Form -border-image](images/bimlflex-ss-app-connections-adf-sql-database-form.png "Azure SQL Database Linked Service Form")
