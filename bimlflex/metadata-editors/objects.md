...
|[Object Type]|The type of `Object` that is either being extracted or created, depending on the `Integration Stage` of the `Connection` associated with the `Object`.|[Dropdown](#Object-Type-Constrained-List)|
|[Model Object Type]|The type of `Object` that you are designing to load.  See the dropdown for a list of the supported types.|[Dropdown](#Model-Object-Type-Constrained-List)|
