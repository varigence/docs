...
There have been significant changes implemented into BimlStudio 2022 R1 since the last major release, BimlStudio 2020 R2.

## BimlStudio Improvements

- Improved and more robust product key caching (bimlc.exe)
- Removed ellipses from status messages on splash screen
- Fixed bug where duplicating an Extension Point in BimlStudio was creating the duplicate in the wrong folder.
- Added ability to connect to Azure SQL BimlFlex databases. Password, MFA, and Integrated connections now supported.
- Added ability to deploy dacpacs directly to Azure SQL databases.
...
| *ServicePrincipalCredential* |  Attribute | String | Specifies the service principal credential to be used during authentication. (Also support *ServicePrincipalCredentialKVS*) |
